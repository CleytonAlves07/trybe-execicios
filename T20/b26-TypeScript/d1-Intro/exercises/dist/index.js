...
console.log(`A área do losango D 32cm e d 18cm: ${Exercise.losango(32, 18)}cm²`);
console.log(`A área do trapézio é: ${Exercise.trapezio(50, 100, 70)}cm²`);
console.log(`A área do círculo é : ${Exercise.circulo(25)}`);
